...
class SetTheory where
  ...
  --
  -- Условие `hP` про однозначность/функциональность (если `P x y` и `P x y'`, то `y = y'`)
  -- превращает это отношение в функцию (в математическом смысле "каждому x — не более одного y"),
