...
/-- Определение 6.3.1 (supremum of a sequence) -/
noncomputable abbrev Sequence.sup (a : Sequence) : EReal := sSup { x | ∃ n ≥ a.m, x = a n }

/-- Определение 6.3.1 (infimum of a sequence) -/
...
/-- Пример 6.3.4 / Упражнение 6.3.1 (a) -/
example : ((fun (n : ℕ) ↦ 1/((n : ℝ)+1)) : Sequence).sup = 1 := by sorry

/-- Пример 6.3.4 / Упражнение 6.3.1 (b) -/
...
/-- Утверждение 6.3.6 (a) (свойство точной верхней грани) / Упражнение 6.3.2 -/
theorem Sequence.le_sup {a : Sequence} {n : ℤ} (hn : n ≥ a.m) : a n ≤ a.sup := by sorry

/-- Утверждение 6.3.6 (b) (свойство точной верхней грани) / Упражнение 6.3.2 -/
theorem Sequence.sup_le_upper {a : Sequence} {M : EReal} (h : ∀ n ≥ a.m, a n ≤ M) : a.sup ≤ M := by sorry

/-- Утверждение 6.3.6 (c) (свойство точной верхней грани) / Упражнение 6.3.2 -/
