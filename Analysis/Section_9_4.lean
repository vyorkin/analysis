...
/--
Определение 9.4.1.  Здесь мы используем определение непрерывности из Mathlib.  Гипотеза {lean}`x₀ ∈ X` не нужна!
-/
...
/-- Утверждение 9.4.7 / Упражнение 9.4.1. -/
...
/-- Утверждение 9.4.10 / Упражнение 9.4.3  -/
theorem Continuous.exp {a : ℝ} (ha : a>0) : Continuous (fun x : ℝ ↦ a ^ x) := by
  sorry

/-- Утверждение 9.4.11 / Упражнение 9.4.4 -/
...
/-- Утверждение 9.4.13 / Упражнение 9.4.5 -/
