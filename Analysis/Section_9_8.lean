...
/-- Утверждение 9.8.3 / Упражнение 9.8.4 -/
...
/-- Упражнение 9.8.4 (без непрерывности) -/
...
/-- Упражнение 9.8.4 (без строгой монотонности) -/
...
/-
Упражнение 9.8.4: сформулируйте и докажите аналог `MonotoneOn.exist_inverse` для убывающих
(`Antitone`) функций.
-/
